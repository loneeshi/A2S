...
def init_alfworld(config_path=None, split="train", stratified_per_type=0):
    ...
    _env = AlfworldAdapter(
        config_path=config_path,
        train_eval=split,
        stratified_per_type=stratified_per_type if stratified_per_type > 0 else None,
    )
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Stratified sampling: N games per task type (0 = disabled, use all games)",
    )
    parser.add_argument(
        "--skip",
        type=int,
    ...
    if _benchmark == "alfworld":
        init_alfworld(
            ...
            split=args.split,
            stratified_per_type=args.stratified_per_type,
        )
    elif _benchmark == "stulife":
